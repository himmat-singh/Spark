package  org.SampleMovies {
  ...
  object Util {
    ...
    val PATH_MOVIES = PATH + "/SampleDatasets/ml-100k/u.item"
    val PATH_USERS = PATH + "/SampleDatasets/ml-100k/u.user"

    //val sqlContext = new SQLContext(org.sparksamples.Util.sc)

    def getMovieData(): RDD[String] = {
      //val movie_data = sc.textFile(PATH + "/SampleDatasets/ml-100k/u.item")
      //return movie_data
      return null
    }
    ...
    def getUserData(): RDD[String] = {
      var user_data = Util.spark.sparkContext.textFile(PATH + "/SampleDatasets/ml-100k/u.user")
      return user_data
    }
