...
object explore_users {
  ...
  def main(args: Array[String]) {
    ...
    val user_fields = sc.textFile("/home/himmat/SampleDatasets/ml-100k/u.user").map(line => line.split("\\|"))
    ...
    val width1 = 600;
    val height1 = 400;
    ChartUtilities.saveChartAsPNG(new File("/home/himmat/SamplePlots/ml-100k/age_histogram.png"), chart1, width1, height1);
    ...
    val width2 = 2000;
    val height2 = 500;
    ChartUtilities.saveChartAsPNG(new File("/home/himmat/SamplePlots/ml-100k/occ_histogram.png"), chart2, width2, height2);
