...
import org.SampleMovies.Util

object CountByRatingChart {

  def main(args: Array[String]) {
    /*val rating_data_raw = Util.sc.textFile("../../SampleDatasets/ml-100k/u.data")
    ...
    val rating_df = spark.read.format("com.databricks.spark.csv")
      ...
      .load("../../SampleDatasets/ml-100k/u.data")
